...
public class FrmsCrewModule {
    ...
    /** User roles */
    enum Role { CUSTOMER, CREW, MANAGER, OWNER }
    ...
    private void checkInvariant() {
        ...
        long crewPlusMgr = users.values().stream()
                                ...
                                .count();
        assert mgr <= crewPlusMgr :
            "Invariant violated: more MANAGERs than (CREW + MANAGER)!";
    }

    // ------------------ USE‑CASE 1: REGISTRATION ------------------
    /**
     * Registers a new **customer** (default) or owner/manager if role supplied.
     *
     * Preconditions
    ...
    public static void main(String[] args) {
        ...
        // Uncomment to see contract violation (duplicate id):
